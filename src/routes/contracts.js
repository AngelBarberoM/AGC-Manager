...
contractsRouter.get('/allContracts', contractsController.getAllContracts)
contractsRouter.get('/:id', contractsController.getContractById)
contractsRouter.delete('/:id', contractsController.deleteContract)
contractsRouter.post('/', contractsController.createContract)
contractsRouter.patch('/:id', contractsController.updateContract)
